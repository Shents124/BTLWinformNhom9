    ...
    public partial class FormLapHoaDon : Form
    {
        ...
        private bool BatLoiCTHoaDon()
        {
           ...
           if(txtSoLuong.Text=="")
            ...
            cthd.ThanhTien = sa.DonGia * cthd.SoLuong;
            if (li.Contains(cthd))
            {
        ...
        private void ThemSanPhamVaoBang()
        {
            ...
            Sach s = db.Saches.SingleOrDefault(s => s.TenSach.ToUpper() == txtTenSanPham.Text.ToUpper());
            row.Cells[1].Value = s.DonGia.ToString();
            row.Cells[2].Value = txtSoLuong.Text;
            row.Cells[3].Value = s.DonGia * int.Parse(txtSoLuong.Text);
            TongTien += s.DonGia * int.Parse(txtSoLuong.Text);
        ...
        private void InHoaDon()
        {
            ...
            foreach (var item in li)
            {
                ...
                PdfPCell cell1 = new PdfPCell(new Phrase(((decimal)item.DonGia).ToString("0,00.##"), font1));
