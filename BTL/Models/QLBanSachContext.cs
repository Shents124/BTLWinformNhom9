...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAMDH\\SQLEXPRESS01;Database=QLBanSach;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ctdondh>(entity =>
            {
                entity.HasKey(e => new { e.MaDonDh, e.MaSach })
                    .HasName("PK__CTDONDH__1687C589852A4171");
            ...
            modelBuilder.Entity<Cthoadon>(entity =>
            {
                entity.HasKey(e => new { e.MaHd, e.MaSach })
                    .HasName("PK__CTHOADON__EC06F1A20B2618D6");
            ...
            modelBuilder.Entity<Ctpnhap>(entity =>
            {
                entity.HasKey(e => new { e.MaPn, e.MaSach })
                    .HasName("PK__CTPNHAP__EC06B0B275D29F81");
            ...
            modelBuilder.Entity<Dondh>(entity =>
            {
                entity.HasKey(e => e.MaDonDh)
                    .HasName("PK__DONDH__DDA492CB122ADF94");
            ...
            modelBuilder.Entity<Hoadon>(entity =>
            {
                entity.HasKey(e => e.MaHd)
                    .HasName("PK__HOADON__2725A6E06BDB338F");
            ...
            modelBuilder.Entity<Khachhang>(entity =>
            {
                entity.HasKey(e => e.MaKh)
                    .HasName("PK__KHACHHAN__2725CF1EAF47F82F");
            ...
            modelBuilder.Entity<Loaisach>(entity =>
            {
                entity.HasKey(e => e.MaLoai)
                    .HasName("PK__LOAISACH__730A57595776A9A4");
            ...
            modelBuilder.Entity<Nhacc>(entity =>
            {
                entity.HasKey(e => e.MaNhaCc)
                    .HasName("PK__NHACC__C87CD3116412A10D");
            ...
            modelBuilder.Entity<Pnhap>(entity =>
            {
                entity.HasKey(e => e.MaPn)
                    .HasName("PK__PNHAP__2725E7F0C6FAD053");
            ...
            modelBuilder.Entity<Sach>(entity =>
            {
                entity.HasKey(e => e.MaSach)
                    .HasName("PK__SACH__B235742DA4B7D4D2");
            ...
            modelBuilder.Entity<Taikhoan>(entity =>
            {
                entity.HasKey(e => e.MaTk)
                    .HasName("PK__TAIKHOAN__2725007070494476");
